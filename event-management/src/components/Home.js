        ...
        <div>
            <div class="mainBody">
                <div class="text--container">
                    <div class="centered">
                        Welcome To DeluxeEvent Your World Of Great Event Awaits We are so
                        glad you are here! You are now part of a growing community of
                        DeluxeEvent, collaborating, and connecting across the globe via our
                        website. Whether you have joined to create something of your own or
                        just to make enquiries, we have got something for you. Let's go!
                    </div>
                </div>
                <div class="works">
                    <h1 style={{ color: "rgb(250, 150, 186)", textAlign: "center" }}>
                        How Deluxe works{" "}
                    </h1>
                    <p style={{}}>
                        Deluxe Event is a platform that gives the best and affordable
